(module
 ...
 (func $~lib/internal/string/compareUTF16 (; 11 ;) (type $iiii) (param $0 i32) (param $1 i32) (param $2 i32) (result i32)
  (local $3 i32)
  (loop $continue|0
   (if
    (if (result i32)
 ...
 (func $~lib/symbol/Symbol.for (; 22 ;) (type $ii) (param $0 i32) (result i32)
  (local $1 i32)
  (if
